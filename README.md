...
| **Memorization Audit** | [docs.sablier.ai](https://docs.sablier.ai/examples/03_memorization_audit/) | [`.ipynb`](examples/03_memorization_audit.ipynb) | NN-distance ratio **R = 0.9288** vs replay-floor R = 0.0161 — **57.7× separation**, synth is genuinely new |
