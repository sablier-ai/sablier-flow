...
| [`02_tstr_predictive_rank.ipynb`](02_tstr_predictive_rank.ipynb) | [docs.sablier.ai](https://docs.sablier.ai/examples/02_tstr_predictive_rank/) | Spearman ρ = **+0.7687**, 95% bootstrap CI [+0.47, +0.95], p = 1.1e-05, n = 24 — synth ranks predict real OOS ranks |
